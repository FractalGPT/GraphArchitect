...
- **Планирование**: Автоматический поиск пути от входа к выходу
...
- **Совместимость**: Автоматическая проверка сочетаемости инструментов
...
- **Исследование**: Иногда выбираем не лучший, чтобы попробовать другие
...
### Задание 1: Отправьте 3 разных запроса
