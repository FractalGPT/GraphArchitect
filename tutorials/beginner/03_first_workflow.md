...
```
1. "Ответить на вопрос: Что такое AI?"
2. "Создать план статьи о Python"
3. "Суммировать этот длинный текст: ..."
```
...
Изучите: [Понимание инструментов](04_understanding_tools.md)
